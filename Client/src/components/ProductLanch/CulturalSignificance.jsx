...
const CulturalSignificance = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-20 right-1/4 w-16 h-16 rounded-full bg-yellow-100/40"></div>
      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-emerald-100 p-4 rounded-xl border-l-4 border-emerald-500 shadow-md"
          >
            <FaQuoteLeft className="text-emerald-500 mb-2" />
